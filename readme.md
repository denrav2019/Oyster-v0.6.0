...
### Functions / Функции
* [User-defined / Пользовательские](#User-defined--Пользовательские)
* [Built-in Functions / Встроенные функции](#Built-in-Functions--Встроенные-функции)
...
Создать сокет. 
Создаёт сокет и возвращает его дескриптор (целое число). При ошибке возвращает `-1`.
Аргументы:
